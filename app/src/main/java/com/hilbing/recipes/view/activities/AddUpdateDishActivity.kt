...
import com.hilbing.recipes.databinding.ActivityAddUpdateDishBinding
import com.hilbing.recipes.databinding.DialogCustomImageSelectionBinding
...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
        ...
        if (v != null) {
            when (v.id) {
                ...
                R.id.et_cooking_time -> {
                    customItemsListDialog(
                        resources.getString(R.string.cooking_time_in_minutes),
    ...
    private fun verifyData(){
        ...
        when {
            TextUtils.isEmpty(mImagePath) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.select_dish_image), Toast.LENGTH_SHORT).show()
            }
            TextUtils.isEmpty(title) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.enter_title), Toast.LENGTH_SHORT).show()
            }
            TextUtils.isEmpty(type) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.select_type), Toast.LENGTH_SHORT).show()
            }
            TextUtils.isEmpty(category) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.select_category), Toast.LENGTH_SHORT).show()
            }
            TextUtils.isEmpty(ingredients) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.enter_ingredients), Toast.LENGTH_SHORT).show()
            }
            TextUtils.isEmpty(cookingTimeInMinutes) -> {
                Toast.makeText(this@AddUpdateDishActivity, resources.getString(R.string.select_minutes), Toast.LENGTH_SHORT).show()
            }
            ...
            Dexter.withContext(this).withPermission(
              ...
              //  Manifest.permission.WRITE_EXTERNAL_STORAGE,
                ...
                override fun onPermissionDenied(p0: PermissionDeniedResponse?) {
                    Toast.makeText(this@AddUpdateDishActivity, "You have the Gallery permission denied", Toast.LENGTH_SHORT).show()
                }
    ...
    private fun showRationalDialogForPermissions(){
        AlertDialog.Builder(this).setMessage(R.string.turned_off_permissions_message)
            .setPositiveButton(R.string.got_to_settings)
            {
                _,_ ->
                try{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(resultCode == Activity.RESULT_OK){
                        ...
                        .listener(object : RequestListener<Drawable> {
                            ...
                            override fun onResourceReady(
                                ...
                                resource?.let {
                                    ...
                                    Log.i("Image Path Gallery", mImagePath)
                                }
                                return false
                            }
            ...
            Log.e("Canceled", "onActivityResult: " + "User cancelled image" )
        }
    }
    ...
    companion object{
        ...
        private const val IMAGE_DIRECTORY = "Recipes"
    }
}